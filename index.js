(function(module) {
  ...
  module.exports = function(options) { return new Repository(options); }
  ...
  function Repository(options) {
    ...
    function init() {
      ...
      return lock.write(function*() {
        ...
        return yield createJournalReader(journalPath, replayExec)
          .then(function() {
            isInitialized = true;
